...
# Métodos para: adição, remoção de elementos nas tuplas não existem, dado o fato o fato das tuplas serem imutáveis.
...
# Para cada número nesse número imprime esse número
for n in tupla:
    print(n)
...
# O acesso de elementos de uma tupla também pe semelhante a de uma lista
...
# Por quê utilzar tuplas?

# - Tuplas são mais rápidas do que listas.
# - Tuplas deixam seu código mais seguro*
# * Isso porque trabalhar com elementos umutáveis traz segurança para o código.
