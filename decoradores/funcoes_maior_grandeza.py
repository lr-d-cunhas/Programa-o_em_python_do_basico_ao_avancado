...
- Quando uma linguagemde de programação suporte HOF, indica que podemos ter funções
...
def faz_me_rir():
    def rir():
        return choice(('hahahahahahhahaha', 'kkkkkkkk', 'yayayayayayayaya'))
    return rir
...
# OBS: neste exemplo estamos retornando a função!
# Repare no (return rir) e na chamada do rindo que tem o ()
...
def fez_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahaha', 'lolololololo', 'kkkkkkkkk'))
...
rindo = fez_me_rir_novamente('Fernanda')
