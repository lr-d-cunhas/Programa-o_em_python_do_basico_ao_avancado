...
# math.isqrt
# raiz quadrada
print(math.isqrt(9))  # 3, inteiro
print(math.sqrt(9))  # 3.0, real

print(math.isqrt(17))  # 4, inteiro
print(math.sqrt(17))  # 4.123105625617661, real
...
seq3 = [1, 3, 3, 12, 20, 8, 2, 6]

print(statistics.multimode(seq1))  # ['a']
print(statistics.multimode(seq2))  # [3]
print(statistics.multimode(seq3))  # [3]
