...
OBS: Nas veersões 2.x do Python, um pacote Python deveria conter dentro dele um
arquivo chamado __init__.py

Nas verssões do Python 3.x, não é mais obrigatória a utilização deste arquivo, mas
