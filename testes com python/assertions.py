...
afirmações utilziadas nos testes.

Utilizamos o 'assert' em uma expressão que queremos checar se é válida ou não
Se a exressão for verdadeira, retorna None e caso seja falsa levanta um erro
...
# Se um programa python for executado com o parâmetro -0, nenhum assertion será validado.
Ou seja todas as suas validações já eram

É melhor não utilizar, se tiver -O seus assert não serão executado
