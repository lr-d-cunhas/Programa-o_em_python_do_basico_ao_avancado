...
Por convenção, todos os testes devem em um test case, devem ter seu nome
iniciado com test_
...
Podemos acressentear (e é recomendado) docstrings nos nossos testes.
"""
