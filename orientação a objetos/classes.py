...
Classes podem conter:
    ...
    outra cor, qual é aluminosidade dela e etc.
...
OBS: Utilizamos a palabra 'pass' em Python quando temos um bloco de código que ainda não está
implementado.

OBS: Quando nomeamos nossas classe em Python utilizamos por convenção o nome com inicial
em maiúsculo. Se o nome for composto, utiliza-se as iniciais de ambas as palavras em maiúsulo,
todas juntas.

Dica Geek: Em computação não utilizamos: Acentuação, caracteres especiais, espaços ou similares
para nomes de classes, atributos, mpetodos, arquivos, diretórios e etc.
