...
que deve ser acecssado/utilizado somente dentro da própria classe  onde ele está declarado,
utiliza-se __ duplo underscore no início de seu nome.

Isso é conheido também como Name Mangling.


"""

# Classes com atributo de Instância Pública
class Lampada:
...
# não vai impedir que façamos acesso aos atributos sinalizados como privados fora da classe.
...
# print(user.__senha)  # AttributeError # nível de segurança
...
# todas as instância da classe. Ou seja, ao invés de cada instância da classe ter seus próprios
# valores como é o caso dos atributos de instâncias, com os stributos de classe todas as instâncias
...
p1 = Produto('PlayStatio 4', 'Video Game', 2300)
p2 = Produto('Xbox S', 'Video Game',  4500)

print(p1.valor)  # Acesso possível, mas incorreto de atributo de classe
print(p2.valor)  # Acesso possível, mas incorreto de atributo de classe

# OBS: Não precisamos criar uma instância de uma classe para fazer aesso a um atributo de classe
...
# OBS: O atributo dinâmcio será exclusivo da instância que o criou.

p1 = Produto('PlayStatio 4', 'Video Game', 2300)
p2 = Produto('Arroz', 'Mercearia', 5.99)

# Criando um atributo dinâmico em tempo de excução
