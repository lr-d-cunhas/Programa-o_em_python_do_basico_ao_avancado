...
que este objeto pode realizar no seus sitema.
...
# O método dunder __init__ é um método especial chamado de construtor e sua
função é construir o objeto a partir da classe.

OBS: Todo elemento em Python que inicia e finaliza com duplo underline é chamado de dunder (Duable Underline)
...
print(Produto.desconto(p1, 40))  # p1 é o próprio objeto self
"""
# Teste 2

"""
user1 = Usuario('Angelina', 'Jolie', 'angelina@gmail.com', '123456')
user2 = Usuario('Felicity', 'Jones', 'felicity@gmail.com', '643234')
...
print(f'Senha User Ciptografada: {user._Usuario__senha}')  # Acesso Errado
