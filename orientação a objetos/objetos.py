...
representação computação, devemos poder criar quantos objetos forem necessários. Podemos pensar
nos objetos/instâncias de uma classe omo variáveis do tipo definido na classe.
"""
...
clil = Cliente('Angelina Jolie', '123.456.789-99')
